...
<main class="flex min-h-[100svh] items-center justify-center px-6 py-16 text-center">
    <div class="max-w-lg">
        <p class="font-mono text-xs uppercase tracking-[0.2em] text-gold">{{ $siteSetting->studio_name ?? 'Waka Shots' }}</p>
        <h1 class="mt-5 font-serif text-4xl text-ivory">This gallery is no longer available.</h1>
